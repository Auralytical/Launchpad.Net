...
// {
//     internal class CoreAudioMidiDevice : MidiDevice
//     {
//         private IntPtr _inDeviceHandle, _outDeviceHandle;
//         private byte[] _readBuffer;

//         internal CoreAudioMidiDevice(string id, string name, DeviceType type)
//             : base(id, name, type) { }
...
//             }
            ...
            //             if (velocity != 0)
            //                 RaiseButtonDown(msgType, midiId);
            //             else
            //                 RaiseButtonUp(msgType, midiId);
            //             break;
            //     }
            // }
//         }
